                ...
                <div className="card shadow-lg border-0 rounded-lg mt-5">
                  <div className="card-header">
                    ...
                    >
                      ...
                      <div>
                        Asegúrese de que el archivo .xlsx para cargar no
                        contenga celdas vacías. Los campos de estado, área,
                        causal y severidad deben coincidir con los valores
                        predefinidos y no se admiten datos no conformes.
                      </div>
                    </div>
                  </div>
                </div>
